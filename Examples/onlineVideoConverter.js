...
if ("undefined" == typeof (onlinevideoconverter)) {
	console.log("OnlineVideoCOnverterInside")
	var onlinevideoconverter = {
		...
		addButtons: function () {
			...
			if (document.getElementById('watch-like-dislike-buttons')) {
				div_embed = document.getElementById('watch-like-dislike-buttons');
				buttonclass = "yt-uix-button yt-uix-button-text yt-uix-tooltip";
				spanclass = "";
			} else if (document.getElementById('watch-headline-user-info')) {
				div_embed = document.getElementById('watch-headline-user-info');
				buttonclass = "yt-uix-button yt-uix-button-default yt-uix-tooltip";
				spanclass = "yt-uix-button-group";
		...
		downloadUrl: function () {
			var e = document.getElementById("conversionFormat");
			var strUser = e.options[e.selectedIndex].value;
			return onlinevideoconverterpath + "&format=" + strUser;
		}
	};

	console.log(onlinevideoconverter.downloadUrl());
}